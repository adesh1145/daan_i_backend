...
class OrderAddressModel(models.Model):
    ...
    state = models.ForeignKey(
        StateModel, related_name='order_state', on_delete=models.CASCADE, blank=True, null=True)
    city = models.ForeignKey(
        CityModel, related_name='order_city', on_delete=models.CASCADE, blank=True, null=True)

    addres_type = models.CharField(max_length=255, choices=[
