...
class AddressView(DonarBaseAuthAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return responseModel(
            status=True,
            data={
                "address": AddressSerializer(addrss, many=True).data
            }
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return responseModel({
                ...
                "message": gettext("addressAdded")
            },
                msg=gettext("addressAdded")
    ...
    def put(self, request, *args, **kwargs):
        ...
        serializer = AddressSerializer(
            data=request.data, context=request, partial=True)

        if serializer.is_valid():
            print(serializer.validated_data['id'])
            address = serializer.update(validated_data=serializer.validated_data,
